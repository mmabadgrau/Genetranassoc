...
<?php if ($idioma=='es') 
  echo "El software Genetranassoc 1.0, bajo licencia GPL 3.0 es proporcionado de las siguientes maneras:";
  else   echo "Software Genetranassoc 1.0 under GNU Public Licence 3.0, is provided in the following formats:";  ?>
</h2>


<p><a href=Genetranassoc1.0.tar.gz>
...
<p><a href=Genetranassoc1.0_x32.gz>
<?php if ($idioma=='es')
